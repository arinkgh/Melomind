    ...
    <footer className="container mx-auto mt-24 p-6">
      <div className="flex flex-col lg:flex-row justify-between gap-10">
        ...
        <div className="w-full lg:w-1/4 flex flex-col gap-4 items-center lg:items-start text-center lg:text-right">
          ...
          <p className="font-semibold text-[16px] text-[#105870] leading-relaxed">
        ...
        <div className="w-full lg:w-1/4 flex flex-col items-center lg:items-start gap-3">
          ...
          <Link href="/" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
            صفحه اصلی
          </Link>
          <Link href="/about" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
            درباره ما
          </Link>
          <Link href="/services" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
            خدمات
          </Link>
          <Link href="/blog" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
            بلاگ
          </Link>
        </div>
        ...
        <div className="w-full lg:w-1/4 flex flex-col items-center lg:items-start gap-3">
          ...
          <a href="tel:01144430438" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
            شماره تلفن: ۰۱۱۴۴۴۳۰۴۳۸
          </a>
          <a href="tel:09385668186" className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]">
          ...
          <a
            ...
            className="font-semibold text-[18px] text-[#105870] hover:text-[#76C144]"
          >
      ...
      {/* bottom copyright */}
      <div className="mt-10 text-center text-[#105870] text-sm border-t pt-4">
