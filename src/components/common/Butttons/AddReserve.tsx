...
export function AddReserve({ text, onClick }: ButtonProps) {
  return (
    <div className="flex flex-wrap items-center gap-1 md:flex-row">
      <Button
        onClick={onClick}
        className="text-secondary w-[200px] bg-background rounded-[110px] cursor-pointer  font-bold hover:bg-amber-50 shadow border-2 py-5.5 px-4.5 flex flex-row justify-around"
      >
        {text}
