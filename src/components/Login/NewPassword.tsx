...
//     { border: "border-[#DCAF0D]", bg: "bg-[#F4C51F]" }, // weak
//     { border: "border-[#2D9CDB]", bg: "bg-[#2D9CDB]" }, // medium
//     { border: "border-[#27AE60]", bg: "bg-[#27AE60]" }, // strong
//   ];
...
//             <div
//               key={i}
//               className={`w-[174px] h-[12px] rounded-md border-2 transition-all duration-300 ${
//                 strength > i - 1
...
//       {/* repeat input */}
//       <div className="relative w-full max-w-md md:max-w-3xl my-2 px-4 md:px-0 mt-6">
//         <IoLockClosedOutline className="absolute right-4 top-1/2 -translate-y-1/2 text-primary text-2xl" />
//         <Input
...
//       {/* button */}
//       <div className="w-full max-w-3xl px-4 md:px-0 mt-5">
//         <LoginBtn text=" تغییر رمز عبور " />
//       </div>
//     </div>
//   );
// };
