  ...
  return (
    <div className="w-full lg:w-1/2 flex flex-col lg:gap-0 gap-4 justify-around px-4 lg:px-10 mt-8 lg:mt-0">
      <div className="flex flex-col gap-4">
        ...
        <h3 className="text-3xl md:text-5xl text-secondary font-bold">خدمات مختص ما</h3>
        <p className="font-semibold text-[16px] md:text-[18px] text-secondary/80 leading-relaxed">
