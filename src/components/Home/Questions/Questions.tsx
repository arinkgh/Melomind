...
//   return (
//     <div className="container mx-auto mt-40 flex flex-col justify-between items-center gap-12">
//       {/* Title */}
//       <QuestionsTitle />
//       {/* Main */}
...
//         <div
//           key={index}
//           className="w-full rounded-[20px] shadow-[#92B3BE1A] shadow-2xl p-8 flex flex-col justify-around gap-6"
//         >
//           <p className="flex items-center gap-3">
//             <span className="text-[#76C144] font-bold text-2xl">
//               {item.number}.
//             </span>
//             <span className="text-[#105870] text-2xl font-bold">
//               {item.title}
//             </span>
//           </p>

//           <p className="text-[#6997a8] font-semibold text-[18px]">
//             {item.desc}
//           </p>
//         </div>
//       ))}
