  ...
  return (
    <div className='container mx-auto rounded-[20px] bg-[#F1F7FA] mt-40 h-[350px] flex flex-row justify-around items-center'>
      ...
      <div className='w-1/2 h-[60%] flex flex-col items-start gap-4'>
        ...
        <h3>
          <span className='text-[#105870] text-5xl font-extrabold'>همین الان میتونی با </span>
          <span className='text-[#76C144] text-5xl font-extrabold'>رزرو نوبت</span> <br/>
          <span className='text-[#105870] text-5xl font-extrabold'>مشکلاتت رو حل کنی!</span>
        </h3>
      </div>
      {/* Button */}
