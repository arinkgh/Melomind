    ...
    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
      {items.map((item, index) => (
        ...
        >
          ...
          <h4 className="font-bold text-xl md:text-2xl text-[#105870] mt-3">
            {item.title}
          </h4>
          ...
          <div className="flex items-center gap-2 mt-4">
            <p className="text-sm md:text-base lg:text-lg text-[#105870] font-bold">
              ادامه مطلب
            </p>
            <ChevronLeft className="text-[#80C244]" size={20} />
          </div>
        </div>
      ))}
    </div>
