...
const HeroText = () => {
  return (
    <div className='lg:h-[380px] md:h-[340px] w-[80%] md:w-[40%] flex flex-col justify-between gap-6 md:gap-0 '>
      <p className='text-secondary lg:text-2xl text-[18px]  font-semibold'>
        متخصص اعصاب و روان (روانپزشک)
      </p>
      <h3 className='text-primary lg:text-7xl text-5xl font-extrabold whitespace-nowrap'>
        دکتر نرجس اقبالی
      </h3>
      <p className='text-primary font-semibold lg:text-[18px] text-xs'>
