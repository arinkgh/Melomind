  ...
  return (
    <div className="flex flex-col gap-8 overflow-x-hidden">
      ...
      {open && selectedItem && (
        ...
        >
          <div
            className="bg-white rounded-xl shadow-lg p-4 sm:p-6 w-[95%] max-w-md sm:max-w-lg md:max-w-xl flex flex-col items-center gap-10"
            onClick={(e) => e.stopPropagation()}
          >
            <DeleteReserveModal selectedItem={selectedItem} setOpen={setOpen} />
          </div>
        </div>
      )}
    </div>
