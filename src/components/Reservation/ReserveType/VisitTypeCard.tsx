  ...
  return (
    <div className="mt-10 w-full flex flex-col md:flex-row items-center justify-center gap-4">
      {[
        ...
        <div
          key={index}
          className="border-2 w-[85%] md:w-[45%] lg:w-[250px] h-[220px] sm:h-[240px] rounded-[20px] flex flex-col items-center justify-center shadow bg-white p-4 cursor-pointer hover:border-secondary transition"
        >
          <Image src={img} alt="#" className="w-20 h-20" />
          <div className="flex flex-col items-center text-center">
            <h4 className="text-primary font-bold text-xl sm:text-2xl">
              {title}
            </h4>
