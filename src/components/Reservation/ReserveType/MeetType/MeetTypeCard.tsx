...
// import { meetTypes } from "@/utils/constants/ReservationCards";
...
//       {meetTypes.map(({ img, title, desc }, index) => (
//         <div
//           key={index}
...
// src/components/reservation/MeetTypeCard.tsx
"use client";
...
const MeetTypeCard: React.FC = () => {
  ...
  const onClick = (item: ServiceItem) => {
    selectItem(item);
    router.push("/reservation/reservetype/meet-type/date"); // next step (your path)
  };
