    ...
    <div className="bg-custom-svg w-full ">
      <div className=" container mx-auto flex flex-col justify-around items-center gap-10">
        ...
        <div className=" w-[80%] h-[200px] md:h-[300px] xl:h-[544px] relative flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-primary/80 w-[97%] h-full  mx-auto mt-4 rounded-[37px] hidden xl:block "></div>
          <div className="absolute inset-3 bg-primary w-[98%] h-full   mx-auto -mt-3 rounded-[20px] hidden xl:block"></div>
          {/* Image */}
          <Image
            src={articleimg}
            alt="#"
